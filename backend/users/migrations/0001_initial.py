# Generated by Django 5.1.12 on 2025-09-07 07:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("admin", "Admin"), ("contractor", "Contractor")],
                        default="contractor",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "code"], name="users_twofa_user_id_229236_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="twofactorcode",
            index=models.Index(
                fields=["expires_at"], name="users_twofa_expires_73da6b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userprofile",
            index=models.Index(
                fields=["two_factor_method"], name="users_userp_two_fac_415043_idx"
            ),
        ),
    ]
